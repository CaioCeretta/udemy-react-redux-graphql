...
import { AdditionalInformation, UserData } from "@/src/utils/firebase/firebase.utils";
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionalInformation) =>
